...
import { Trophy, User, Mail, Lock, Eye, EyeOff, Zap } from "lucide-react";
...
function Register() {
  ...
  return (
    <div className="min-h-screen bg-[#020408] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_40%_at_20%_80%,rgba(168,85,247,0.10)_0%,transparent_60%)]" />
      ...
      <div className="relative w-full max-w-110 bg-[rgba(6,12,20,0.85)] backdrop-blur-2xl border border-purple-500/20 rounded-[20px] p-10 shadow-[0_0_30px_rgba(168,85,247,0.25),0_0_80px_rgba(124,58,237,0.1)] animate-fadeSlideUp">
        ...
        <div className="flex flex-col gap-3.5">
          ...
          {/* Terms */}
          <p className="text-[11px] text-slate-500/60 tracking-wide leading-relaxed mt-0.5">
            By registering, you agree to our{" "}
            <a href="#" className="text-purple-500/70 hover:text-purple-400 transition-colors">
              Terms of Service
            </a>{" "}
            and{" "}
            <a href="#" className="text-purple-500/70 hover:text-purple-400 transition-colors">
